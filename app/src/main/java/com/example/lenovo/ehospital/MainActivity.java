...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            fragment = new DoctorActivity();

        } else if (id == R.id.nav_services) {
            fragment = new ServicesActivity();


        } else if (id == R.id.nav_pharmacy) {
            fragment = new PharmacyActivity();

        } else if (id == R.id.nav_bloodDonor) {
            fragment = new BloodDonorActivity();

        } else if (id == R.id.nav_ambulance) {
            fragment = new AmbulanceActivity();

        } else if (id == R.id.nav_donateBlood) {
            fragment = new DonateBloodActivity();
